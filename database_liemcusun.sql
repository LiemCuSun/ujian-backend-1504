...
CREATE TABLE `movies` (
  ...
  PRIMARY KEY (`id`),
  KEY `connect_movie_status_idx` (`status`),
  CONSTRAINT `connect_movie_status` FOREIGN KEY (`status`) REFERENCES `movie_status` (`id`),
  CONSTRAINT `connect_schedule` FOREIGN KEY (`id`) REFERENCES `schedules` (`id`)
...
CREATE TABLE `schedules` (
  ...
  KEY `show_time_idx` (`time_id`),
  CONSTRAINT `location` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`),
  CONSTRAINT `show_time` FOREIGN KEY (`time_id`) REFERENCES `show_times` (`id`)
...
INSERT INTO `schedules` VALUES (1,1,1,3),(2,1,1,4),(3,1,1,5),(4,1,2,1),(5,1,2,5),(6,1,2,6),(7,1,3,1),(8,1,3,2),(9,1,3,3),(10,2,2,2),(11,2,2,3),(12,2,2,6),(13,3,1,3),(14,3,3,5),(15,3,3,6),(16,4,1,1),(17,4,2,2),(18,4,2,4),(19,4,3,3),(20,5,1,5),(21,5,2,5),(22,5,3,5),(23,6,1,1),(24,6,2,2),(25,6,3,3),(26,8,1,4),(27,8,1,6),(28,9,1,1),(29,9,1,2),(31,9,1,3);
...
INSERT INTO `users` VALUES (1,'1612335747167','liemcusun','cusunliem@gmail.com','f5ef790d0c14c30faf5a92eed1c789eb',1,3);
...
-- Dump completed on 2021-02-03 17:27:01
